...
sys.path.insert(0, os.path.abspath('.'))  # TODO - do I need all of these?
sys.path.insert(0, os.path.abspath('../'))  # TODO - do I need all of these?
...
htmlhelp_basename = 'BELbioAPIdoc'
...
latex_documents = [
    (master_doc, 'BELbioAPI.tex', 'BEL.bio API Documentation',
     'William Hayes', 'manual'),
]
...
man_pages = [
    (master_doc, 'belbioapi', 'BEL.bio API Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'BELbioAPI', 'BEL.bio API Documentation',
     author, 'BELbioAPI', 'One line description of project.',
     'Miscellaneous'),
]
